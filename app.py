    ...
    if event.message.text == "呼叫助理":
        ...
        carousel_template = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url=locations[0][4], title=locations[0][0], text=str("天氣："+locations[0][2]+" 溫度："+locations[0][3]+"\n"+locations[0][1]),
                    ...
                    CarouselColumn(
                        thumbnail_image_url=locations[1][4], title=locations[1][0], text=str("天氣："+locations[1][2]+" 溫度："+locations[1][3]+"\n"+locations[1][1]),
