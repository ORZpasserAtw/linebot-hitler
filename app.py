...
def handle_message(event):
    if event.message.text == "呼叫助理":
        ...
        flex_message = FlexSendMessage(
            alt_text="幫助 Flex",
            contents=BubbleContainer(body=BoxComponent(layout="horizontal",spacing="none",margin="none",contents=[
                    BoxComponent(layout="vertical",spacing="none",margin="none", contents=[
