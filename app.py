            ...
            contents=CarouselContainer(contents=[
                    BubbleContainer(size="kilo",body=BoxComponent(layout="vertical", spacing="sm",contents=[
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="臺北", data="臺北-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="新北", data="新北-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="基隆", data="基隆-天氣及空氣品質"),style="secondary", color="#9CDBD9")
                        ]),
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="桃園", data="桃園-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="新竹", data="新竹-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="苗栗", data="苗栗-天氣及空氣品質"),style="secondary", color="#9CDBD9")
                        ]),
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="臺中", data="臺中-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="彰化", data="彰化-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="南投", data="南投-天氣及空氣品質"),style="secondary", color="#9CDBD9")
                        ]),
                    ])),
                    BubbleContainer(size="kilo",body=BoxComponent(layout="vertical", spacing="sm",contents=[
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="雲林", data="雲林-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="嘉義", data="嘉義-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="臺南", data="臺南-天氣及空氣品質"),style="secondary", color="#9CDBD9")
                        ]),
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="高雄", data="高雄-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="屏東", data="屏東-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="宜蘭", data="宜蘭-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                        ]),
                        BoxComponent(layout="horizontal", spacing="sm", contents=[
                            ButtonComponent(action=PostbackAction(label="花蓮", data="花蓮-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            ButtonComponent(action=PostbackAction(label="臺東", data="臺東-天氣及空氣品質"),style="secondary", color="#9CDBD9"),
                            TextComponent(text="　")
                        ]),
                    ]))
                ])
...
def handle_postback(event):
    if event.postback.data == "臺北-天氣及空氣品質":
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,中山')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,板橋')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,基隆')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,桃園')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,新竹')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,苗栗')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,西屯')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,彰化')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,南投')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,斗六')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,嘉義')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,臺南')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,前鎮')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,屏東')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,宜蘭')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,花蓮')
        ...
        aqi = requests.get('https://data.epa.gov.tw/api/v1/aqx_p_432?limit=100&api_key=9be7b239-557b-4c10-9775-78cadfc555e9&format=json&filters=SiteName,EQ,臺東')
