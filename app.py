    ...
    if event.message.text == "呼叫助理":
        ...
        flex_message = FlexSendMessage(
            ...
            contents=CarouselContainer(contents=[
                    ...
                    hero=ImageComponent(url="https://i.imgur.com/tUXJI3R.png",size="full",aspectMode="cover"),
                    body=BoxComponent(layout="vertical",contents=[
...
def handle_postback(event):
    ...
    if event.postback.data == "臺北-天氣及空氣品質":
        ...
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text=
        "【推薦行程】\n台灣好玩的地方真的很多，這裡推薦北、中、南、東適合親子同遊的景點，點擊「了解更多」可以知道更多的景點資訊，點擊「我不喜歡」會有多個景點讓你選擇！"))
